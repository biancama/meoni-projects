...
public class Cookie {
    ...
    public void setExpires(String expires) {
        ...
        this.expireTime = -1;
        BiancaLogger.getLogger().severe("Cookie: no Format for " + expires + " found!");
        return;
    }
    ...
    public boolean isExpired() {
        ...
        if (this.hostTime == -1) {
            BiancaLogger.getLogger().severe("Cookie: no HostTime found! ExpireStatus cannot be checked " + this.host + " " + this.key);
            return false;
        } else {
    ...
    public void setHostTime(String Date) {
        ...
        this.hostTime = -1;
        BiancaLogger.getLogger().severe("Cookie: no Format for " + Date + " found!");
        return;
    }
