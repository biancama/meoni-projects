...
public class RandomUserAgent {
    ...
    private static String randomDate(String[] releaseDate) {
        ...
        String month = FormatterUtils.fillString((rCal.get(Calendar.MONTH) + 1) + "", "0", "", 2);
        String day = FormatterUtils.fillString(rCal.get(Calendar.DAY_OF_MONTH) + "", "0", "", 2);
        String hour = "";
        if (releaseDate.length == 4) {
            hour = FormatterUtils.fillString(rand.nextInt(24) + "", "0", "", 2);
        }
