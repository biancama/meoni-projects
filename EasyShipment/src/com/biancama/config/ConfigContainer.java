...
public class ConfigContainer implements Serializable {
    ...
    /**
     * ConfigElement ist ein Browser für eine Datei public ConfigEntry(int
    ...
    public ConfigContainer() {
        this(BiancaL.L("config.container.defaultname", "Allgemein"));
    }

    public ConfigContainer(String title) {
        this.title = title;
        propertyInstance = FileSystemUtils.getConfiguration();
