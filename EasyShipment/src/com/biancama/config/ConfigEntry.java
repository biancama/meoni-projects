...
import com.biancama.controlling.ListController;
...
public class ConfigEntry implements Serializable {
    ...
    private Object[] list;
    private final Vector<ConfigEntry> listener = new Vector<ConfigEntry>();
    ...
    public boolean isConditionalEnabled(PropertyChangeEvent evt) {
        if (evt.getSource() == conditionEntry) { return compareValue.equals(evt.getNewValue()); }
        return true;
    }
    ...
    public ConfigEntry setEnabledCondidtion(ConfigEntry conditionEntry, boolean compareValue) {
        if (conditionEntry.getType() != ConfigContainer.TYPE_CHECKBOX) {
