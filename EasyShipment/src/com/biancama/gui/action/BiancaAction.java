...
package com.biancama.gui.action;
...
import com.biancama.gui.swing.ShortCuts;
 ...
 * @author Coalado
 */
public abstract class BiancaAction extends AbstractAction {
     ...
     *            optional action id
     */
    public BiancaAction(String title, int actionID) {
        super(title);
        this.actionID = actionID;
    }
     ...
     *            icon of the action
     */
    public BiancaAction(String l, ImageIcon ii) {
        super(l, ii);
    }
    ...
    public void setIcon(String key) {
        ...
        putValue(AbstractAction.SMALL_ICON, BiancaTheme.II(key, 16, 16));
        putValue(AbstractAction.LARGE_ICON_KEY, BiancaTheme.II(key, 24, 24));
            ...
            try {
                for (int i = 0; i < split.length - 1; ++i) {
                    if (new Regex(split[i], "^CTRL$").matches()) {
                        ...
                        BiancaLogger.getLogger().info(this.getTitle() + " Shortcuts: skipping wrong modifier " + mod + " in " + accelerator);
                    }
                }
                ...
                BiancaLogger.getLogger().finest(this.getTitle() + " Shortcuts: mapped " + accelerator + " to " + ks);
            } catch (Exception e) {
                BiancaLogger.exception(e);
                ...
                BiancaLogger.getLogger().finest(this.getTitle() + " Shortcuts: mapped " + accelerator + " to " + ks + " (Exception)");
            }
        }
    }
     ...
     * @return
     */
    public BiancaAction setActionListener(ActionListener actionListener) {
     ...
     * @return
     */
    public BiancaAction setTitle(String title) {
        putValue(NAME, title);
        return this;
    }
     ...
     * @return
     */
    public BiancaAction setIcon(ImageIcon ii) {
