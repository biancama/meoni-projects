...
package com.biancama.gui.swing.settings;
...
public class GUIConfigEntry implements ActionListener, ChangeListener, PropertyChangeListener, DocumentListener {
    ...
    public GUIConfigEntry(ConfigEntry cfg) {
        ...
        case ConfigContainer.TYPE_LINK:
            ...
            try {
                input[0] = new BiancaLink(configEntry.getLabel(), new URL(configEntry.getPropertyName()));
        ...
        case ConfigContainer.TYPE_TEXTFIELD:
            ...
            input[0] = new BiancaTextField();

            doc = ((BiancaTextField) input[0]).getDocument();
            doc.addDocumentListener(this);
            input[0].setEnabled(configEntry.isEnabled());
            ((BiancaTextField) input[0]).setHorizontalAlignment(SwingConstants.RIGHT);
        ...
        case ConfigContainer.TYPE_LISTCONTROLLED:
            ...
            doc = ((BiancaTextArea) input[0]).getDocument();
            doc.addDocumentListener(this);
        ...
        case ConfigContainer.TYPE_BROWSEFILE:
            if (configEntry.getLabel().trim().length() > 0) {
                decoration = new JLabel(configEntry.getLabel());
            }
        ...
        case ConfigContainer.TYPE_COMBOBOX_INDEX:
            ...
            if (configEntry.getList().length > 0) {
                if (configEntry.getList()[0] instanceof BiancaLabelContainer) {
                    ((JComboBox) input[0]).setRenderer(new BiancaLabelListRenderer());
        ...
        if (configEntry.getHelptags() != null) {
            String tooltip = BiancaL.LF("gui.tooltips.quickhelp", "Quickhelp available: %s (ctrl+shift+CLICK)", configEntry.getHelptags());
            if (decoration != null) {
    ...
    public Object getText() {
        switch (configEntry.getType()) {
        case ConfigContainer.TYPE_LINK:
            return ((BiancaLink) input[0]).getUrl().toString();
        case ConfigContainer.TYPE_PASSWORDFIELD:
            return new String(((JPasswordField) input[0]).getPassword());
        case ConfigContainer.TYPE_TEXTFIELD:
            return ((BiancaTextField) input[0]).getText();
        case ConfigContainer.TYPE_TEXTAREA:
            return ((BiancaTextArea) input[0]).getText();
        case ConfigContainer.TYPE_CHECKBOX:
    ...
    public void setData(Object text) {
        ...
        case ConfigContainer.TYPE_LINK:
            try {
                ((BiancaLink) input[0]).setUrl(new URL(text == null ? "" : text.toString()));
        ...
        case ConfigContainer.TYPE_PASSWORDFIELD:
            ...
            break;
        case ConfigContainer.TYPE_TEXTFIELD:
            ((BiancaTextField) input[0]).setText(text == null ? "" : text.toString());
            break;
        case ConfigContainer.TYPE_LISTCONTROLLED:
            ((BiancaTextArea) input[0]).setText(text == null ? "" : text.toString());
            break;
        case ConfigContainer.TYPE_TEXTAREA:
            ((BiancaTextArea) input[0]).setText(text == null ? "" : text.toString());
            break;
