...
public abstract class ToolBarAction extends BiancaAction {
    ...
    public ToolBarAction(String menukey, String iconkey, int id) {
        super(BiancaL.L("gui.menu." + menukey + ".name", menukey));
        setId(menukey);
        this.setActionID(id);
        if (iconkey != null) {
            setIcon(iconkey);
        }
        setMnemonic(BiancaL.L("gui.menu." + menukey + ".mnem", "-"));
        setAccelerator(BiancaL.L("gui.menu." + menukey + ".accel", "-"));
        setToolTipText(BiancaL.L("gui.menu." + menukey + ".tooltip", menukey));
    ...
    public final void actionPerformed(ActionEvent e) {
        if (this.type == Types.TOGGLE && JavaUtils.getJavaVersion() < 1.6) {
