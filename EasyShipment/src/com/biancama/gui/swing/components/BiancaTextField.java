...
public class BiancaTextField extends JTextField implements FocusListener {

    private boolean autoselect = false;

    private static final long serialVersionUID = -4013847546677327448L;

    public BiancaTextField(String text) {
        super(text);
        addFocusListener(this);
        JUndoManager.addUndoRedo(this);
    }

    public BiancaTextField() {
        this(null);
    }

    public BiancaTextField(boolean b) {
        this(null);
        autoselect = b;
    }
