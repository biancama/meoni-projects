...
public abstract class BiancaTextEditorTableColumn extends BiancaTextTableColumn implements ActionListener {

    private static final long serialVersionUID = 1859257712113327417L;
    private JTextField text;

    public BiancaTextEditorTableColumn(String name, BiancaTableModel table) {
        super(name, table);
