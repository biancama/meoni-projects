...
public class ComboBrowseFile extends JPanel implements ActionListener {
    ...
    private final ArrayList<ActionListener> listenerList = new ArrayList<ActionListener>();
    ...
    private File getPath() {
        ...
        if (fc.showOpenDialog(this) == BiancaFileChooser.APPROVE_OPTION) { return fc.getSelectedFile(); }
        return null;
    }
    ...
    private void initGUI() {
        ...
        btnBrowse = new JButton(BiancaL.L("gui.btn_select", "Auswählen"));
