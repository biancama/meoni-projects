        ...
        public void drop(DropTargetDropEvent event) {
            ...
            if (transferable.isDataFlavorSupported(DataFlavor.javaFileListFlavor)) {
                ...
                try {
                    ...
                    BiancaLogger.exception(flavorException);
                    event.dropComplete(false);
                } catch (IOException ioException) {
                    BiancaLogger.exception(ioException);
                    event.dropComplete(false);
                }
            } else {
                event.rejectDrop();
...
class WebBrowserPane extends JEditorPane {
    ...
    private final ArrayList<URL> history = new ArrayList<URL>();
...
class WebToolBar extends JToolBar implements HyperlinkListener {
    ...
    private final WebBrowserPane webBrowserPane;
        ...
        urlTextField.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                try {
                    ...
                    BiancaLogger.exception(urlException);
                }
            }
        });
