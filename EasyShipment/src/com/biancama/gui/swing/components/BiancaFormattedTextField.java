...
public class BiancaFormattedTextField extends JFormattedTextField implements FocusListener {

    private boolean autoselect = false;

    private static final long serialVersionUID = -4013847546677327448L;

    public BiancaFormattedTextField(java.text.Format format) {
        super(format);
        addFocusListener(this);
        JUndoManager.addUndoRedo(this);
    }
    public BiancaFormattedTextField(String text) {
        super(text);
        addFocusListener(this);
        JUndoManager.addUndoRedo(this);
    }
