...
public class BiancaGeoCode {
    ...
    static {
        ...
        LANGUAGES.put("ab", new String[] { "Abkhazian", "�?ҧ�?уа" });
        ...
        LANGUAGES.put("be", new String[] { "Belarusian", "Белару�?ка�?" });
        LANGUAGES.put("bg", new String[] { "Bulgarian", "българ�?ки език" });
        LANGUAGES.put("bh", new String[] { "Bihari", "भोजप�?री" });
        ...
        LANGUAGES.put("cr", new String[] { "Cree", "ᓀ�?��?�ᔭ�??�??�?�" });
        LANGUAGES.put("cs", new String[] { "Czech", "�?esky; �?eština" });
        LANGUAGES.put("cu", new String[] { "Church Slavic", "ѩзыкъ �?ловѣнь�?къ" });
        ...
        LANGUAGES.put("dz", new String[] { "Dzongkha", "རྫོང་�?" });
        LANGUAGES.put("ee", new String[] { "Ewe", "�?ʋɛgbɛ" });
        ...
        LANGUAGES.put("fa", new String[] { "Persian", "�?ارسی" });
        ...
        LANGUAGES.put("gu", new String[] { "Gujarati", "ગ�?જરાતી" });
        LANGUAGES.put("gv", new String[] { "Manx", "Gaelg; Gailck" });
        LANGUAGES.put("ha", new String[] { "Hausa", "هَو�?سَ" });
        LANGUAGES.put("he", new String[] { "Hebrew", "עברית" });
        LANGUAGES.put("hi", new String[] { "Hindi", "हिन�?दी; हिंदी" });
        ...
        LANGUAGES.put("is", new String[] { "Icelandic", "�?slenska" });
        LANGUAGES.put("it", new String[] { "Italian", "Italiano" });
        LANGUAGES.put("iu", new String[] { "Inuktitut", "�?�ᓄᒃᑎ�?ᑦ" });
        LANGUAGES.put("ja", new String[] { "Japanese", "Nihongo" });
        LANGUAGES.put("ka", new String[] { "Georgian", "ქ�?რთული" });
        ...
        LANGUAGES.put("km", new String[] { "Khmer", "ភាសា�?្មែរ" });
        LANGUAGES.put("kn", new String[] { "Kannada", "ಕನ�?ನಡ" });
        ...
        LANGUAGES.put("mi", new String[] { "M�?ori", "te reo M�?ori" });
        LANGUAGES.put("mk", new String[] { "Macedonian", "македон�?ки јазик" });
        ...
        LANGUAGES.put("oj", new String[] { "Ojibwa", "�?�ᓂᔑᓈ�?�ᒧ�?��?" });
        ...
        LANGUAGES.put("ru", new String[] { "Russian", "ру�?�?кий �?зык" });
        LANGUAGES.put("rw", new String[] { "Kinyarwanda", "Ikinyarwanda" });
        LANGUAGES.put("sa", new String[] { "Sanskrit", "संस�?कृतम�?" });
        ...
        LANGUAGES.put("sk", new String[] { "Slovak", "sloven�?ina" });
        LANGUAGES.put("sl", new String[] { "Slovenian", "slovenš�?ina" });
        ...
        LANGUAGES.put("sr", new String[] { "Serbian", "�?рп�?ки језик" });
        ...
        LANGUAGES.put("ta", new String[] { "Tamil", "தமிழ�?" });
        LANGUAGES.put("te", new String[] { "Telugu", "తెల�?గ�?" });
        LANGUAGES.put("tg", new String[] { "Tajik", "ไทย" });
        LANGUAGES.put("ti", new String[] { "Tigrinya", "ት�?ርኛ" });
        ...
        LANGUAGES.put("ty", new String[] { "Tahitian", "Reo M�?`ohi" });
        LANGUAGES.put("ug", new String[] { "Uighur", "Україн�?ька" });
        ...
        LANGUAGES.put("zh", new String[] { "Chinese", "中文 (Zh�?ngwén), 汉语, 漢語" });
